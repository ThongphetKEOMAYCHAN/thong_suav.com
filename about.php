...
<html>
  ...
  <body>
    ...
    <section class = "about container">
      ...
      <div class = "row">
        <div class = "row-left">
             <div class="ab-img-border">
               <div class="ab-img-container">
                    <img src = "images/tub.png" alt = "about photo">
                  </div>
             </div>
        </div>

        <div class = "row-right">
          <p class = "text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio praesentium numquam alias soluta incidunt? Similique assumenda, voluptatibus saepe quae iusto ratione dicta consectetur nesciunt perspiciatis!</p>
          <div class = "about-content">
            <ul>
              ...
              <li class = "text">
                <span>Email: </span>
                <span>thong99485942@gmail.com</span>
              </li>
              <li class = "text">
                <span>Phone: </span>
                <span>+856 2077973984</span>
              </li>
              <li class = "text">
               <span>Facebook: </span>
               <span>Thongphet Yang</span>
             </li>
            </ul>
          </div>
